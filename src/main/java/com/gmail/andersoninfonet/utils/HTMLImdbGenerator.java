...
public class HTMLImdbGenerator implements HTMLGenerator {
    
    private final PrintWriter printWriter;

    public HTMLImdbGenerator(PrintWriter printWriter) {
    ...
    private String generateBody(List<? extends Content> contents) {
        ...
        """.formatted(generateHeader("IMDB Top 250 Movies"), generateCards(contents));
    }
