...
public class HTMLMixedGenerator implements HTMLGenerator {
    
    private final PrintWriter printWriter;

    public HTMLMixedGenerator(PrintWriter printWriter) {
    ...
    private String generateBody(List<? extends Content> contents) {
        ...
        """.formatted(generateHeader("Mixed Api"), generateCards(contents));
    }
    ...
    private String generateCards(List<? extends Content> contents) {
        return  contents.stream()
            .map(movie ->  
                ...
                """.formatted(movie.title(), movie.year(), movie.type(), movie.urlImage(), movie.title(), movie.rating())
            )
